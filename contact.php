    ...
    <div class="container-fluid  animatedParent animateOnce">
        ...
        <div class="row animated  slowest fadeInUpShort delay-1000">
            ...
            <div class="col-md-6 col-lg-4" style="margin-top: -40px;">
                <form id="contact" action="contact.php" enctype="multipart/form-data" method="POST" style="padding-top: 66px;padding-bottom: 30px;">
                    <fieldset>
    ...
    <div class="container">
        <div class="row footer">
            <div class="col-xs-12 footer-copy">
                &copy;<script>new Date().getFullYear()>document.write(new Date().getFullYear());</script>, Affiliated Dialysis California.
            </div>
        </div>
    </div>
</body>
...
if(isset($_POST['SubmitForm'])) {
  ...
  $text = "name: $name \nemail: $email\nphone: $phone\nmessage:$message";
  $mgClient = new Mailgun('key-df67ab54700a0a8dc7cda97b9b4e4583');
  $domain = "mg.affiliateddialysisca.com";
  $result = $mgClient->sendMessage($domain, array(
    "from" => "info@affiliateddialysisca.com",
    "to" => "info@affiliateddialysisca.com",
